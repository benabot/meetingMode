...
7. **Capture decissions**: Update `docs/DECISIONS.md` after doing or planing something
8. **Capture status**: Update `docs/PROJECT_STATUS.md` after coding or implemanting
